...
public class MatchBlock {
    ...
    public boolean matches(AbstractBlockState blockState) {
        return Block.getIdByBlock(blockState.getBlock()) == this.blockId && Matches.metadata(blockState.getBlock().getMeta(blockState), this.metadatas);
    }
